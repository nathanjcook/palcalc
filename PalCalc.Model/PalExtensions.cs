...
namespace PalCalc.Model
{
    ...
    {
        public static Pal ToPal(this string s, PalDB db) => db.Pals.SingleOrDefault(p => p.Name == s) ?? throw new ArgumentException($"Unknown pal with english name {s}");
        public static Pal ToPal(this string s, IEnumerable<Pal> pals) => pals.SingleOrDefault(p => p.Name == s) ?? throw new ArgumentException($"Unknown pal with english name {s}");
        public static Pal InternalToPal(this string s, PalDB db) => db.Pals.SingleOrDefault(p => p.InternalName.Equals(s, StringComparison.OrdinalIgnoreCase)) ?? throw new ArgumentException($"Unknown pal with internal name {s}");
        public static Pal InternalToPal(this string s, IEnumerable<Pal> pals) => pals.SingleOrDefault(p => p.InternalName.Equals(s, StringComparison.OrdinalIgnoreCase)) ?? throw new ArgumentException($"Unknown pal with internal name {s}");
